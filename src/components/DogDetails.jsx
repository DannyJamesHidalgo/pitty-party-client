...
<div class=" bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="p-5">
        ...
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{dog?.story} {dog?.name} is a {dog?.age} year old {dog?.gender}. <br/> {dog?.gender === 'Male' ? 'He' : 'She'} is "{dog?.health_status}" in health and {dog?.color} in color.<br/> {dog?.name} has been with us since {dog?.arrival_date}. <br/> If you are intrested in adopting {dog?.gender === 'Male' ? 'him' : 'her'} click the link below! </p>
